...
export function pickOnboardedPooledUser() {
  if (validOnboardedPoolIndices.length === 0) {
    return { email: '', password: ONBOARDED_POOL_PASSWORD, clientId: SIGNUP_CLIENT_ID, totpSecret: undefined };
  }
  ...
  return {
    ...
    clientId: SIGNUP_CLIENT_ID,
    totpSecret: onboardedPoolSecrets[index],
  };
}
...
export function pickOnboardedEntityPooledUser() {
  if (validOnboardedEntityPoolIndices.length === 0) {
    return { email: '', password: ONBOARDED_ENTITY_POOL_PASSWORD, clientId: SIGNUP_CLIENT_ID, totpSecret: undefined };
  }
  ...
  return {
    ...
    clientId: SIGNUP_CLIENT_ID,
    totpSecret: onboardedEntityPoolSecrets[index],
  };
}
